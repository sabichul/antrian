...
<div class="navbar">
                            <div class="navbar-inner">
                                            <div class="fileupload-buttonbar">
                                                <ul class="nav">
                                                    <li><a href="?link=daftar-customer-transaksi"><i class="fontello-icon-th-list"></i>Back</a></li> 
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="<?php echo "$control";?>?link=daftar-customer-transaksi&act=delete&id=<?php echo "$r[id]"?>" class="btn btn-danger danger">Delete</a>
            </div>
        </div>
    </div>
</div>
