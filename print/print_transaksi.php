      ...
      //                   //masukin antrian ke database                        
						// include 'config/database.php';
						// include "config/fungsi_zona.php";
						// mysql_query("INSERT INTO `temp_transaksi`( `nomor_antrian`, `time`) VALUES ('$antrian','$wita')");
...
printer_draw_text($p, "Bandar Udara H. Aroeppala, Selayar",100,0);
